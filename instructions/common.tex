...
\usepackage{listings}
\lstset{basicstyle=\ttfamily,escapechar=@,tabsize=4,commentstyle=\color{darkgray},frame=l,framerule=1pt}
...
\NewDocumentCommand{\cmdinwsl}{m}{\mono{wsl -d} {\ttfamily\imagename{}} \mono{#1}}
