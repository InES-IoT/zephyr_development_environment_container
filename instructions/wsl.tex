...
\end{monobox}
  ...
  \item Create a folder for the environment and import the provided WSL image.
        \begin{monobox}
mkdir C:\WSL\@\imagename{}@
wsl --import @\imagename{}@ `
  C:\WSL\@\imagename{}@ `
  "$env:USERPROFILE\Downloads\@\imagename{}@_ARCH_wsl.tar.gz"
\end{monobox}
    ...
    \begin{infobox}
      ...
      \begin{center}
        \begin{tikzpicture}
          ...
          \node [anchor=south west] {\includegraphics[width=.5\paperwidth]{terminal_open_wsl_tab}};
          \draw (4.8,1.9) [gray,fill] rectangle (8.5,2.25);
          \node at (4.81,2.06) [anchor=west] {\fontsize{7pt}{7pt}\selectfont\textcolor{white}{\imagename}};
        \end{tikzpicture}
      \end{center}
    \end{infobox}
\end{itemize}
